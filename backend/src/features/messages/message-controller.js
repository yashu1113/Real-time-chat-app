...
export const deleteMessage = asyncHandler(async (req, res) => {
  ...
  // Logic: Content is removed, but the message record remains with isDeleted: true
  message.isDeleted = true;
  message.content = "This message was deleted"; // Optional: Clear content to be sure
  await message.save();

  const io = req.app.get("socketio");
  if (io) {
    // Broadcast message deletion to the chat room
    broadcastToRoom(io, message.chat.toString(), "messageDeleted", {
